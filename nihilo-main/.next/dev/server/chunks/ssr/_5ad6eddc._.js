...
"[project]/src/app/(marketing)/assessment/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AssessmentPage() {
    const [stage, setStage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('intake');
    ...
    const calculateReadinessScore = ()=>{
        ...
        const totalQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"].length;
    ...
    const sendEmail = ()=>{
        setIsSending(true);
        const phases = [
            ...new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"].map((q)=>q.phase))
        ];
        const formattedResults = phases.map((phase)=>{
            const phaseQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"].filter((q)=>q.phase === phase);
    ...
    const handleAnswer = (option)=>{
        setAnswers({
            ...answers,
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"][currentStep].id]: option
        });
        if (currentStep < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"].length - 1) {
    ...
    if (stage === 'test') {
        const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"][currentStep];
        const progress = (currentStep + 1) / __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSESSMENT_QUESTIONS"].length * 100;
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_5ad6eddc._.js.map