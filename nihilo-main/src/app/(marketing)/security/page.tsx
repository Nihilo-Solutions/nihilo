...
export const metadata: Metadata = {
  ...
  description: 'Zero-data retention, cloud sovereignty, and audit integrity - our security-first approach to enterprise AI.',
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="animate-in fade-in slide-in-from-left-4 duration-700">
            <Link href="/" className="flex items-center gap-2 text-zinc-500 hover:text-blue-400 transition-colors mb-8 group">
