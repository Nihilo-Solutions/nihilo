...
Source: https://nihilosolutions.com/use-cases
Site: https://nihilosolutions.com/llms-full.txt

Use cases

# Examples of work we automate.
These are starting points, not a closed list. If someone on your team still does the same steps every week, we can look at it, even if it is not on this page.
...
### The next step that lives in someone's head
Today
...
Other examples we look at include intake, status updates, scheduled checks, invoice backups, inventory counts, and file routing. If it is rules-based, currently done by a person, and you can walk us through last week's run, bring it.
- Intake and handoff
- Status updates
- Scheduled checks
- Invoice backups
...
## Your process does not have to match an example.
Book a call. Bring the work that keeps coming back. We will tell you if it is worth automating.
