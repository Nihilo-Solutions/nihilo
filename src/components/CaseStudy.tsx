...
const CaseStudy: React.FC = () => {
    return (
        <section className="py-24 px-6 bg-navy-950 relative overflow-hidden border-t border-navy-900 border-b">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-cyan-900/10 via-navy-950 to-navy-950"></div>
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="bg-navy-900/40 border border-navy-800 rounded-2xl p-8 md:p-12 shadow-2xl backdrop-blur-sm relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative z-10">
                            <div className="grid grid-cols-1 gap-4">
                                <div className="bg-navy-950 border border-navy-800 p-6 rounded-xl text-center">
